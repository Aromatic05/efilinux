...
builddepends=()
makedepends=(autoreconf automake autopoint flex gcc intltool-extract intltool-merge intltool-update libtool make msgfmt pkg-config)
...
package() {
    local -a keep=(/usr/bin/galculator /usr/share/applications/)
