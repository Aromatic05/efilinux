...
run_component "$ROOT/003-graphical/extra-cmake-modules"
run_component "$ROOT/003-graphical/fcitx5-gtk"
...
run_component "$ROOT/003-graphical/papirus-icon-theme"
run_component "$ROOT/003-graphical/papirus-maia-icon-theme"
run_component "$ROOT/003-graphical/catos-icon-theme"
run_component "$ROOT/003-graphical/breeze-cursor-theme"
run_component "$ROOT/003-graphical/matcha-gtk-theme"
