...
run_component "$ROOT/002-system/session-services"
run_component "$ROOT/002-system/storage-services"
run_component "$ROOT/002-system/network-services"
run_component "$ROOT/002-system/audio-services"
